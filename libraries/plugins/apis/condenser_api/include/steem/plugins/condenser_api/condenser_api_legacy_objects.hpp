...
struct legacy_signed_block
{
      ...
      signing_key( b.signing_key )
   {
      ...
      transaction_ids.insert( transaction_ids.begin(), b.transaction_ids.begin(), b.transaction_ids.end() );
   }
...
FC_REFLECT( steem::plugins::condenser_api::legacy_signed_block,
            (previous)(timestamp)(transaction_merkle_root)(extensions)(witness_signature)(transactions)(block_id)(signing_key)(transaction_ids) )
